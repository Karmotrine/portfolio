export default function Footer() {
    return (
        <footer className="bg-grid bg-szgrid flex flex-col md:flex-row-reverse md:justify-around items-center space-y-2 mx-auto pb-4 ">
            <div className="flex flex-row justify-between space-x-2">
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.linkedin.com/in/yuan-u-6450a0205/"
                >
                    <svg 
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://github.com/Karmotrine"
                >
                    <svg 
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.instagram.com/y_414o1/"
                >
                    <svg 
                        xmlns="http://www.w3.org/2000/svg"
                        width="36"
