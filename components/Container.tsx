...
function NavItem({href, name, icon}) {
    ...
    return (
        <NextLink href={href}>
            <a className="hidden cursor-pointer h-1/8 group md:flex flex-1 border-y-2 border-transparent transition-border-width py-0.5 duration-500 ease-linear hover:border-brown-800 hover:py-0.5">
                <div className="h-1/8 transition-slowest ease z-10 w-0 bg-brown-800 transition-width duration-200 ease-in-and-out group-hover:w-full">
                    ...
                    <a className="absolute font-semibold text-brown-800 group-hover:text-gray-250">{name}</a>
                    </div>
                </div>
